 ...
 * 
 */
public class normalizedTranslator  implements  mv_if
{ 
	/**
	...
	public normalizedTranslator() {set();}

    /** Copy constructor. */
	public normalizedTranslator(final normalizedTranslator A) {set(A);}


	/** Constructs a new normalizedTranslator with scalar value 'scalar'. */
	public normalizedTranslator(final double scalar) {set(scalar);}

	/** Constructs a new normalizedTranslator from mv.
	 *  @param A The value to copy. Coordinates that cannot be represented
	 *  are silently dropped.
	 */
	public normalizedTranslator(final mv A /*, final int filler */) {set(A);}

	/** Constructs a new normalizedTranslator. Coordinate values come from 'A'. */
	public normalizedTranslator(final CoordinateOrder co, final double[] A) {set(co, A);}
	
	/** Constructs a new normalizedTranslator with each coordinate specified. */
	public normalizedTranslator(final CoordinateOrder co,  final double e1_ni, final double e2_ni, final double e3_ni) {
...
public final void set(final normalizedTranslator a)
{
	m_e1_ni = a.m_e1_ni;
	m_e2_ni = a.m_e2_ni;
	m_e3_ni = a.m_e3_ni;
	 ...
	 */
	public final double get_scalar() { return 1.0;}
