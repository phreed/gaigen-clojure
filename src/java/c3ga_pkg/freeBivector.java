 ...
 * 
 */
public class freeBivector  implements  mv_if
{ 
	/**
	 ...
	 */
	public static final int E2_E3_NI = 1;

	/**
	 * index of coordinate for -1*e1^e3^ni in freeBivector
	 */
	public static final int E3_E1_NI = 2;
	...
	public static final CoordinateOrder coord_e1e2ni_e2e3ni_e3e1ni = CoordinateOrder.coord_e1e2ni_e2e3ni_e3e1ni;
	...
	public freeBivector() {set();}

    /** Copy constructor. */
	public freeBivector(final freeBivector A) {set(A);}
	 ...
	 */
	public freeBivector(final mv A /*, final int filler */) {set(A);}

	/** Constructs a new freeBivector. Coordinate values come from 'A'. */
	public freeBivector(final CoordinateOrder co, final double[] A) {set(co, A);}
	
	/** Constructs a new freeBivector with each coordinate specified. */
	public freeBivector(final CoordinateOrder co,  final double e1_e2_ni, final double e2_e3_ni, final double e3_e1_ni) {
...
public final void set(final CoordinateOrder co, final double _e1_e2_ni, final double _e2_e3_ni, final double _e3_e1_ni)
{
...
public final void set(final freeBivector a)
{
	...
	public final double largestCoordinate() {
		...
		if (Math.abs(m_e3_e1_ni) > maxValue) { maxValue = Math.abs(m_e3_e1_ni); }
		return maxValue;
	}
	/**
	 * Returns the absolute largest coordinate,
	...
	public final double[] largestBasisBlade()  {
		...
		if (Math.abs(m_e3_e1_ni) > maxValue) { maxValue = Math.abs(m_e3_e1_ni); bm = 26; }
	 ...
	 */
	public final double get_e3_e1_ni() { return m_e3_e1_ni;}
	/**
	 * Sets the -1*e1^e3^ni coordinate.
	 */
	public final void set_e3_e1_ni(double e3_e1_ni) { m_e3_e1_ni = e3_e1_ni;}
	/**
