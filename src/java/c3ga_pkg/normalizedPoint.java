...
{ 
	...
	public normalizedPoint(final CoordinateOrder co, final double[] A) {set(co, A);}
	
	/** Constructs a new normalizedPoint with each coordinate specified. */
	public normalizedPoint(final CoordinateOrder co,  final double e1, final double e2, final double e3, final double ni) {
		set(co, e1, e2, e3, ni);
	}
...
public final void set(final normalizedPoint a)
{
	 ...
	 */
	public final double get_no() { return 1.0;}
	/**
