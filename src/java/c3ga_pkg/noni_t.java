 ...
 * 
 */
public class noni_t  implements  mv_if
{ 
	/**
    ...
    /** Copy constructor. */
	public noni_t(final noni_t A) {set(A);}
	 ...
	 */
	public noni_t(final mv A /*, final int filler */) {set(A);}
...
public final void set(final noni_t a)
{
	 ...
	 */
	public final double get_no_ni() { return 1.0;}
	/**
